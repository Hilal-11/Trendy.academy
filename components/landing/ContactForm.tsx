...
export default function ContactForm() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      {/* ── page shell ── */}
      <div className="mx-auto container px-2 lg:px-6 py-16 ">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-5 ">
          ...
          {/* ── LEFT: form ── */}
          <Card className="lg:col-span-3 border-border/60 bg-neutral-100/20 dark:bg-neutral-900/20">
          ...
          <div className="flex flex-col gap-5 lg:col-span-2 ">
            ...
            {/* contact info */}
            <Card className="dark:bg-neutral-900/20">
